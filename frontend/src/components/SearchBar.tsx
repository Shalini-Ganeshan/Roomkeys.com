  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-4 items-center justify-between lg:flex-row sm:flex-col">
        ...
        <div className="flex flex-row sm:gap-2 md:gap-0 lg:gap-0 w-1/2 lg:w-auto">
          <div className="flex-[0.5] flex-row space-x-1 min-w-[100px]">
            ...
            <input
              ...
              placeholder="Adults"
              className="w-1/4 lg:w-1/2 bg-white border-2 border-indigo-800 shadow-xl rounded-xl text-sm p-2"
            />
          </div>

...
>
  <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-4">
    ...
    <div className="flex items-center border-2 border-indigo-800 shadow-xl rounded-xl bg-white p-1 flex-1 lg:flex-[0.5]">
      <label className="flex items-center justify-center w-full">
        <span className="text-md text-center flex-1">Adults:</span>
        <input
          className="w-16 p-1 focus:outline-none text-center  ml-[-55px] md:ml-0 text-sm"
          type="number"
          min={1}
          max={20}
          value={adultCount}
    ...
    <div className="flex items-center border-2 border-indigo-800 shadow-xl rounded-xl bg-white p-1 flex-1 lg:flex-[0.5]">
      <label className="flex items-center justify-center w-full">
        <span className="text-md text-center flex-1">Children:</span>
        <input
          className="w-16 p-1 focus:outline-none text-center  ml-[-55px] md:ml-0 text-sm"
          type="number"
          min={0}
